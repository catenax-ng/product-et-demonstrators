...
class IntroContent extends React.Component{
    ...
    render() {
      ...
      return (
        ...
        <>
          <Typography variant="h4">Privacy Tradeoff</Typography>
          <p>
          ...
          <Typography variant="h5">The Copy Problem</Typography>
          <p>
          ...
          <Typography variant="h5">The Bundling Problem</Typography>
          <p>
          ...
          <Typography variant="h5">The Recursive Enforcement Problem</Typography>
          <p>
          ...
          <Typography variant="h4">Privacy Risks</Typography>
          <p>
          ...
          <Typography variant="h4">Privacy Attacks</Typography>
        </>
      )
    }
  }
